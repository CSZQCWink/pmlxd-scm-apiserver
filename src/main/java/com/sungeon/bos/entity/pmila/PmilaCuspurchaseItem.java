...
@RestTable(tableName = "M_V_CUSPURCHASEITEM", refTableName = "M_V_CUSPURCHASEITEM", description = "经销商采购单明细",
		defaultQueryFilter = "M_V_CUSPURCHASEITEM.ISACTIVE = 'Y'")
public class PmilaCuspurchaseItem extends BaseRestBean {
