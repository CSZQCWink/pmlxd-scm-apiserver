...
public class PurchaseDaoImpl extends BaseDaoImpl implements IPurchaseDao {
	...
	@SgExceptionField(exception = UpdateFailException.class)
	@Override
	public List<PurchaseEntity> queryPurchase() {
		return purchaseMapper.queryPurchase();
	}
	...
	@Override
	public List<String> queryRelevancyDocnoByDocno() {
		return purchaseMapper.queryRelevancyDocno();
	}

	@Override
	public String queryRelevancyDocnoByDocno(String docNo) {
		return purchaseMapper.queryRelevancyDocnoByDocno(docNo);
	}
